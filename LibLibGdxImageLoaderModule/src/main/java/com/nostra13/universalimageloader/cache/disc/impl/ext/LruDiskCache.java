...
public class LruDiskCache implements DiskCache {
    ...
    /** {@value */
    public static final Pixmap.Format DEFAULT_COMPRESS_FORMAT = Pixmap.Format.RGBA8888;
    /** {@value */
    ...
    protected Pixmap.Format compressFormat = DEFAULT_COMPRESS_FORMAT;
...
//	@Override
//	public boolean save(String imageUri, Pixmap Pixmap) throws IOException {
//		DiskLruCache.Editor editor = cache.edit(getKey(imageUri));
//		if (editor == null) {
//			return false;
//		}
...
//		try {
//			savedSuccessfully = Pixmap.compress(compressFormat, compressQuality, os);
//		} finally {
//			IoUtils.closeSilently(os);
//		}
...
//	}
    ...
    public void setCompressFormat(Pixmap.Format compressFormat) {
