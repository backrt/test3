...
import com.nostra13.universalimageloader.core.display.PixmapDisplayer;
 ...
 * <li>decoding options (including Pixmap decoding configuration)</li>
 ...
 * <li>pre-processor for image Pixmap (before caching in memory)</li>
 * <li>post-processor for image Pixmap (after caching in memory, before displaying)</li>
 * <li>how decoded {@link Pixmap} will be displayed</li>
 * </ul>
 * <p/>
...
public final class DisplayImageOptions {
    ...
    private final Pixmap imageOnLoading;
    private final Pixmap imageForEmptyUri;
    private final Pixmap imageOnFail;
    ...
    private final PixmapProcessor preProcessor;
    private final PixmapProcessor postProcessor;
    private final PixmapDisplayer displayer;
    ...
    public Pixmap getImageOnLoading(Resources res) {

        return loadPixmapformResource(res, imageResOnLoading);

//        if (imageResOnLoading <= 0)
//            return null;
//
//        try {
//            InputStream inputStream = res.openRawResource(imageResOnLoading);
//            Gdx2DPixmap gdx2DPixmap = new Gdx2DPixmap(inputStream, Gdx2DPixmap.GDX2D_FORMAT_RGBA8888);
...
//        return null;
    ...
    public Pixmap getImageForEmptyUri(Resources res) {

        return loadPixmapformResource(res, imageResForEmptyUri);

//        if (imageResForEmptyUri <= 0)
//            return null;
//
//        try {
//            InputStream inputStream = res.openRawResource(imageResForEmptyUri);
//            Gdx2DPixmap gdx2DPixmap = new Gdx2DPixmap(inputStream, Gdx2DPixmap.GDX2D_FORMAT_RGBA8888);
//            return new Pixmap(gdx2DPixmap);
//
//        } catch (Exception e) {
...
//        return null;
    ...
    public Pixmap getImageOnFail(Resources res) {
        return loadPixmapformResource(res, imageResOnFail);
//        if (imageResOnFail <= 0)
//            return null;
//
//        try {
//            InputStream inputStream = res.openRawResource(imageResOnFail);
//            Gdx2DPixmap gdx2DPixmap = new Gdx2DPixmap(inputStream, Gdx2DPixmap.GDX2D_FORMAT_RGBA8888);
//            return new Pixmap(gdx2DPixmap);
//
//        } catch (Exception e) {
...
//        return null;
    ...
    private Pixmap loadPixmapformResource(Resources res, int resourceId) {
        if (resourceId <= 0)
            return null;

        Pixmap pixmap = null;
        try {
//            pixmap = ImageLoader.getInstance().loadImageSync("resource://" + resourceId, this);

            //从缓存中取
            ImageSize imageSize = new ImageSize(100, 100);
            String resourceMemoryKey = MemoryCacheUtils.generateKey("drawable://" + resourceId, imageSize);

            System.out.println("resouceMemoryKey = " + resourceMemoryKey);

            pixmap = ImageLoader.getInstance().getMemoryCache().get(resourceMemoryKey);
            if (pixmap == null) {
                //加载资源
                ...
                //添加到memory cache
                ImageLoader.getInstance().getMemoryCache().put(resourceMemoryKey, pixmap);
            }
    ...
    public PixmapProcessor getPreProcessor() {
        return preProcessor;
    }

    public PixmapProcessor getPostProcessor() {
        return postProcessor;
    }

    public PixmapDisplayer getDisplayer() {
        return displayer;
    }
    ...
    public static class Builder {
        ...
        private Pixmap imageOnLoading = null;
        private Pixmap imageForEmptyUri = null;
        private Pixmap imageOnFail = null;
        ...
        private PixmapProcessor preProcessor = null;
        private PixmapProcessor postProcessor = null;
        private PixmapDisplayer displayer = DefaultConfigurationFactory.createPixmapDisplayer();
         ...
         */
        public Builder showImageOnLoading(Pixmap pixmap) {
            imageOnLoading = pixmap;
            return this;
        }
         ...
         */
        public Builder showImageForEmptyUri(Pixmap pixmap) {
            imageForEmptyUri = pixmap;
            return this;
        }
         ...
         */
        public Builder showImageOnFail(Pixmap pixmap) {
            imageOnFail = pixmap;
            return this;
        }
         ...
         * size for decoding image to Pixmap. Default value - {@link ImageScaleType#IN_SAMPLE_POWER_OF_2}
         */
        ...
        /**
         * Sets Pixmap processor which will be process Pixmaps before they will be cached in memory. So memory cache
         * will contain Pixmap processed by incoming preProcessor.<br />
         * Image will be pre-processed even if caching in memory is disabled.
         */
        public Builder preProcessor(PixmapProcessor preProcessor) {
            this.preProcessor = preProcessor;
            return this;
        }

        /**
         * Sets Pixmap processor which will be process Pixmaps before they will be displayed in
         ...
         */
        public Builder postProcessor(PixmapProcessor postProcessor) {
            this.postProcessor = postProcessor;
            return this;
        }

        /**
         * Sets custom {@link PixmapDisplayer displayer} for image loading task. Default value -
         * {@link DefaultConfigurationFactory#createPixmapDisplayer()}
         */
        public Builder displayer(PixmapDisplayer displayer) {
