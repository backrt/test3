...
/**
 * Singletone for image loading and displaying at {@link Actor Actors}<br />
...
public class ImageLoader {
    ...
    private static final String ERROR_WRONG_ARGUMENTS = "Wrong arguments were passed to displayImage() method (Actor reference must not be null)";
    ...
    public void displayImage(String uri, ImageAware imageAware, DisplayImageOptions options,
        ...
        if (TextUtils.isEmpty(uri)) {
            ...
            if (options.shouldShowImageForEmptyUri()) {
                imageAware.setImagePixmap(options.getImageForEmptyUri(configuration.resources));
            } else {
                imageAware.setImagePixmap(null);
            }
        ...
        Pixmap bmp = configuration.memoryCache.get(memoryCacheKey);
        if (bmp != null) {
            ...
            if (options.shouldShowImageOnLoading()) {
                imageAware.setImagePixmap(options.getImageOnLoading(configuration.resources));
    ...
    /**
     * Adds display image task to execution pool. Image will be set to Actor when it's turn. <br/>
     * Default {@linkplain DisplayImageOptions display image options} from {@linkplain ImageLoaderConfiguration
     * configuration} will be used.<br />
     * <b>NOTE:</b> {@link #init(ImageLoaderConfiguration)} method must be called before this method call
     *
     * @param uri   Image URI (i.e. "http://site.com/image.png", "file:///mnt/sdcard/image.png")
     * @param Actor {@link Actor} which should display image
     * @throws IllegalStateException    if {@link #init(ImageLoaderConfiguration)} method wasn't called before
     * @throws IllegalArgumentException if passed <b>Actor</b> is null
     */
    public void displayImage(String uri, Actor Actor) {
        displayImage(uri, new ImageViewAware(Actor), null, null, null);
    }
     ...
     * @throws IllegalArgumentException if passed <b>Actor</b> is null
     */
    public void displayImage(String uri, Actor Actor, ImageSize targetImageSize) {
        displayImage(uri, new ImageViewAware(Actor), null, targetImageSize, null, null);
    }
     ...
     * @throws IllegalArgumentException if passed <b>Actor</b> is null
     */
    public void displayImage(String uri, Actor Actor, DisplayImageOptions options) {
        displayImage(uri, new ImageViewAware(Actor), options, null, null);
    }
     ...
     * @throws IllegalArgumentException if passed <b>Actor</b> is null
     */
    public void displayImage(String uri, Actor Actor, ImageLoadingListener listener) {
        displayImage(uri, new ImageViewAware(Actor), null, listener, null);
    }
    ...
    public void displayImage(String uri, Actor Actor, DisplayImageOptions options,
                             ImageLoadingListener listener) {
        displayImage(uri, Actor, options, listener, null);
    }
    ...
    public void displayImage(String uri, Actor Actor, DisplayImageOptions options,
                             ImageLoadingListener listener, ImageLoadingProgressListener progressListener) {
        displayImage(uri, new ImageViewAware(Actor), options, listener, progressListener);
    }
     ...
     *
     * @param uri             Image URI (i.e. "http://site.com/image.png", "file:///mnt/sdcard/image.png")
     * @param targetImageSize Minimal size for {@link Pixmap} which will be returned in
     *                        and scaled to {@link Pixmap} of the size which is <b>equal or larger</b> (usually a bit
     ...
     *
     * @param uri Image URI (i.e. "http://site.com/image.png", "file:///mnt/sdcard/image.png")
     * @return Result image Pixmap. Can be <b>null</b> if image loading/decoding was failed or cancelled.
     * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called before
     */
    public Pixmap loadImageSync(String uri) {
        Log.e("imageLoader","loadImageSync = "+uri);
     ...
     * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called before
     */
    public Pixmap loadImageSync(String uri, DisplayImageOptions options) {
     ...
     *
     * @param uri             Image URI (i.e. "http://site.com/image.png", "file:///mnt/sdcard/image.png")
     * @param targetImageSize Minimal size for {@link Pixmap} which will be returned. Downloaded image will be decoded
     *                        and scaled to {@link Pixmap} of the size which is <b>equal or larger</b> (usually a bit
     *                        larger) than incoming targetImageSize.
     * @return Result image Pixmap. Can be <b>null</b> if image loading/decoding was failed or cancelled.
     * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called before
     */
    public Pixmap loadImageSync(String uri, ImageSize targetImageSize) {
     ...
     * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called before
     */
    public Pixmap loadImageSync(String uri, ImageSize targetImageSize, DisplayImageOptions options) {
        if (options == null) {
            options = configuration.defaultDisplayImageOptions;
        }
        ...
        return listener.getLoadedPixmap();
    }
    ...
    /**
     * Returns URI of image which is loading at this moment into passed
     * {@link com.badlogic.gdx.scenes.scene2d.Actor Actor}
     */
    public String getLoadingUriForView(Actor Actor) {
        return engine.getLoadingUriForView(new ImageViewAware(Actor));
    }
     ...
     * {@link com.badlogic.gdx.scenes.scene2d.Actor Actor}.
     *
     * @param Actor {@link com.badlogic.gdx.scenes.scene2d.Actor Actor} for which display task will be cancelled
     */
    public void cancelDisplayTask(Actor Actor) {
        engine.cancelDisplayTaskFor(new ImageViewAware(Actor));
    }
    ...
    private static class SyncImageLoadingListener extends SimpleImageLoadingListener {
        ...
        private Pixmap loadedImage;

        @Override
        public void onLoadingComplete(String imageUri, Actor actor, Pixmap loadedImage) {
            this.loadedImage = loadedImage;
        }

        public Pixmap getLoadedPixmap() {
            return loadedImage;
        }
    }
}
