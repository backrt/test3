...
public final class ImageLoaderConfiguration {
	...
	final PixmapProcessor processorForDiskCache;
	...
	public static class Builder {
		...
		private PixmapProcessor processorForDiskCache = null;
		...
		public Builder discCacheExtraOptions(int maxImageWidthForDiskCache, int maxImageHeightForDiskCache,
				PixmapProcessor processorForDiskCache) {
		 ...
		 * @param processorForDiskCache      null-ok; {@linkplain PixmapProcessor Pixmap processor} which process images before saving them in disc cache
		 */
		...
		/**
		 * When you display an image in a small {@link com.badlogic.gdx.scenes.scene2d.Actor Actor} and later you try to display
		 * this image (from identical URI) in a larger {@link com.badlogic.gdx.scenes.scene2d.Actor Actor} so decoded image of
		 ...
		 * be used for every {@linkplain ImageLoader#displayImage(String, com.badlogic.gdx.scenes.scene2d.Actor) image display call}
