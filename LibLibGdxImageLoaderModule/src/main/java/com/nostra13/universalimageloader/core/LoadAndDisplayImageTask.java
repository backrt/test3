...
/**
 * Presents load'n'display image task. Used to load image from Internet or file system, decode it to {@link Pixmap}, and
 * display it in {@link com.nostra13.universalimageloader.core.imageaware.ImageAware} using {@link DisplayPixmapTask}.
 *
...
final class LoadAndDisplayImageTask implements Runnable, IoUtils.CopyListener {
    ...
    private static final String LOG_GET_IMAGE_FROM_MEMORY_CACHE_AFTER_WAITING = "...Get cached Pixmap from memory after waiting. [%s]";
    ...
    private static final String ERROR_PROCESSOR_FOR_DISK_CACHE_NULL = "Pixmap processor for disk cache returned null [%s]";
    ...
    public void run() {
        ...
        DisplayPixmapTask displayPixmapTask = new DisplayPixmapTask(bmp, imageLoadingInfo, engine, loadedFrom);
        runTask(displayPixmapTask, syncLoading, handler, engine);
    }
    ...
    private Pixmap tryLoadPixmap() throws TaskCancelledException {
        Pixmap pixmap = null;
        try {
            ...
            if (pixmap == null || pixmap.getWidth() <= 0 || pixmap.getHeight() <= 0) {
                ...
                checkTaskNotActual();
//				pixmap = decodeImage(imageUriForDecoding);
                if(imageFile == null)
    ...
    private boolean tryCacheImageOnDisk() throws TaskCancelledException {
        ...
        System.out.println("tryCacheImageOnDisk == "+loaded);
    ...
    private boolean downloadImage() throws IOException {
        ...
        System.out.println("downloadImage  +uru =="+uri);
...
//	/** Decodes image file into Pixmap, resize it and save it back */
...
//			Pixmap bmp = decoder.decode(decodingInfo);
...
//                    imageAware.setImageDrawable(options.getImageOnFail(configuration.resources));
                    imageAware.setImagePixmap(options.getImageOnFail(configuration.resources));
                }
