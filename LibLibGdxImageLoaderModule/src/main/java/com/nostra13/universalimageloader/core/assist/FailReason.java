...
public class FailReason {
	...
	public static enum FailType {
		...
		/**
		 * Error while
		 * {@linkplain android.graphics.PixmapFactory#decodeStream(java.io.InputStream, android.graphics.Rect, android.graphics.PixmapFactory.Options)
		 ...
		 */
		NETWORK_DENIED,
		/** Not enough memory to create needed Pixmap for image */
		OUT_OF_MEMORY,
