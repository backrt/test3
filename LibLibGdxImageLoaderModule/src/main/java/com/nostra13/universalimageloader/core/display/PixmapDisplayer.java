...
/**
 * Displays {@link Pixmap} in {@link com.nostra13.universalimageloader.core.imageaware.ImageAware}. Implementations can
 * apply some changes to Pixmap or any animation for displaying Pixmap.<br />
 ...
 * @since 1.5.6
 */
public interface PixmapDisplayer {
	/**
	 * Displays Pixmap in {@link com.nostra13.universalimageloader.core.imageaware.ImageAware}.
	 ...
	 */
	void display(Pixmap Pixmap, ImageAware imageAware, LoadedFrom loadedFrom);
}
