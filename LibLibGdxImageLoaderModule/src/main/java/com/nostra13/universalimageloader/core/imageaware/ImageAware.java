...
//	boolean setImageDrawable(Drawable drawable);
    ...
    /**
     * Sets image Pixmap into this image aware view.<br />
     * Actually it's used only in
     * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
     *
     * @return <b>true</b> if Pixmap was set successfully; <b>false</b> - otherwise
     */
    boolean setImagePixmap(Pixmap Pixmap);
}
