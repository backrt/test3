...
//		return new StringBuilder(imageUri).toString();
	...
	/**
	 * Searches all Pixmaps in memory cache which are corresponded to incoming URI.<br />
	 ...
	 */
	public static List<Pixmap> findCachedPixmapsForImageUri(String imageUri, MemoryCache memoryCache) {
		List<Pixmap> values = new ArrayList<Pixmap>();
