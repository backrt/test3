...
public class GdxScaleableView extends GdxBaseView {
    ...
    public GdxScaleableView(float scaleX,
                            float scaleY,
                            float animationTime,
                            float loseFocusAlpha) {
        super();
    ...
    public void gainFocusAnimation() {
        ...
        this.addAction(Actions.parallel(
                Actions.scaleTo(animationScaleX, animationScaleY, animationTime),
    ...
    public void loseFocusAnimation() {
        this.clearActions();
        this.addAction(Actions.parallel(
                Actions.scaleTo(DEFAULT_ORIGIN, DEFAULT_ORIGIN, animationTime),
